...
- `"offcpu"`:  Records sleeper-to-waker kernel-stack edges, total blocked time, and wakeup-to-run latency with bpftrace. The optional first argument overrides the default application `comm` filter.
## PlotType

...
- `"numa_locality"`:  Records start/end global and per-node NUMA allocation, locality, automatic-balancing hint-fault, and page-migration counters. Raw counter snapshots are preserved in `numa-locality.json`.
## PlotType

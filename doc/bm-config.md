...
- `"perf_c2c"`:  Records Arm SPE samples through the `perf` monitor and preserves a topology snapshot plus `perf c2c` memory-level, HITM, and shared-cacheline evidence. This monitor requires an Arm SPE PMU.
## PlotType

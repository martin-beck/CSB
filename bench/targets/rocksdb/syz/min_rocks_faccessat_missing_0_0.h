...
//      buffer: {2e 2f 65 74 63 2f 6c 64 2e 73 6f 2e 70 72 65 6c 6f 61 64 00} (length 0x14)
//    }
//    mode: open_mode = 0x4 (8 bytes)
//  ]
memcpy((void*)(0x20002000ul+PTR_OFFSET), "./etc/ld.so.preload\000", 20);
	res = syscall(__NR_faccessat, UNIQUE_VAR(ctx->dirfd), /*pathname=*/0x20002000ul+PTR_OFFSET, /*mode=S_IROTH*/4ul);

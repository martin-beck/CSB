...
//      int32 = 0x0 (4 bytes)
//    }
//    op: futex_op = 0x81 (8 bytes)
//    val: int32 = 0x1 (4 bytes)
//    timeout: nil
//    addr2: nil
//    val3: int32 = 0x0 (4 bytes)
//  ]
*(uint32_t*)(0x20100500ul+PTR_OFFSET) = 0;
	res = syscall(__NR_futex, /*addr=*/0x20100500ul+PTR_OFFSET, /*op=FUTEX_PRIVATE_FLAG|FUTEX_WAKE*/0x81ul, /*val=*/1, /*timeout=*/0ul, /*addr2=*/0ul, /*val3=*/0);

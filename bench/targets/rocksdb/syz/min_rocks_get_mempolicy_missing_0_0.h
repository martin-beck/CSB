...
static inline int UNIQUE_FUNC(bm_dispatch_operation)(thread_ctx_t* ctx, size_t op_id)
{
	...
	intptr_t res = 0;
	V_UNUSED(res);
//  get_mempolicy arguments: [
//    mode: nil
//    nodemask: ptr[out, int64] {
//      int64 = 0x0 (8 bytes)
//    }
//    maxnode: intptr = 0x101 (8 bytes)
//    addr: VMA[0x1000]
//    flags: mempolicy_flags = 0x4 (8 bytes)
//  ]
	res = syscall(__NR_get_mempolicy, /*mode=*/0ul, /*nodemask=*/0x20b0eac0ul+PTR_OFFSET, /*maxnode=*/0x101ul, /*addr=*/0x20b0f000ul+PTR_OFFSET, /*flags=MPOL_F_MEMS_ALLOWED*/4ul);

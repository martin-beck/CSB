...
//    mode: mbind_mode = 0x5 (8 bytes)
//    nodemask: ptr[in, int64] {
//      int64 = 0xf (8 bytes)
//    }
//    maxnode: intptr = 0x100 (8 bytes)
//  ]
*(uint64_t*)(0x20b0eb80ul+PTR_OFFSET) = 0xf;
	res = syscall(__NR_set_mempolicy, /*mode=MPOL_PREFERRED|0x4*/5ul, /*nodemask=*/0x20b0eb80ul+PTR_OFFSET, /*maxnode=*/0x100ul);

...
//  mmap arguments: [
//    addr: VMA[0x100000]
//    len: len = 0x100000 (8 bytes)
//    prot: mmap_prot = 0x3 (8 bytes)
//    flags: mmap_flags = 0x32 (8 bytes)
//    fd: fd (resource)
//    offset: intptr = 0x0 (8 bytes)
//  ]
	res = syscall(__NR_mmap, /*addr=*/0x20402000ul+PTR_OFFSET, /*len=*/0x100000ul, /*prot=PROT_WRITE|PROT_READ*/3ul, /*flags=MAP_FIXED|MAP_ANONYMOUS|MAP_PRIVATE*/0x32ul, /*fd=*/(intptr_t)-1, /*offset=*/0ul);

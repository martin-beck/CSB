...
static void
remove_tmp_dir_contents_best_effort_min_rocks_write_fcntl_7_0_prog(int dirfd)
{
    ...
    while ((entry = readdir(dp)) != NULL) {
        ...
        if (childfd >= 0) {
            remove_tmp_dir_contents_best_effort_min_rocks_write_fcntl_7_0_prog(
                childfd);
...
bm_target_dereg(thread_ctx_t *ctx, size_t tid)
{
    ...
    munmap((void *)ctx->mmap_offsets_min_rocks_write_fcntl_7_0_prog,
           MMAP_LENGTH);
